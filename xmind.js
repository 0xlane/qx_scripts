...
const RESULT_PROFILE = {
  ...
  "social_accounts" : {
    "wx" : {
      "unionid" : "oaj5XwMOGvHgbePJ2LhWx0l-hdPE",
      "nickname" : "这是谁"
    }
  },
  "last_signin" : 1724738394026,
  "_code" : 200,
  "news_frequency" : 9,
  "first_name" : "",
  "emails" : [
...
const RESUTL_ACTIVE = {
  ...
  "bindXmind" : 1,
  "deviceId" : "F7C0772D-CD53-415B-989A-85F99BB7D6CD",
  "_code" : 200,
  "expireTime" : 4091494480000,
...
function Main(){
  if (magicJS.isResponse){
    if (PROFILE_REGEX.test(magicJS.request.url)){
      try{
        let body = JSON.stringify(RESULT_PROFILE);
        magicJS.done({body});
      }
      catch(err){
