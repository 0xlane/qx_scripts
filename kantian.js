/* 看天vip解锁
 * hostname = kantianapi.geovisearth.com
 * surge/Loon/shadowrocket
 * 看天 = type=http-response,requires-body=1,max-size=0,pattern=https?:\/\/kantianapi\.geovisearth\.com\/v2\/user\/(?:mine|guest\/info)\/query\?,script-path= https://raw.githubusercontent.com/0xlane/qx_scripts/master/kantian.js
 * QuantumultX    
 * https?:\/\/kantianapi\.geovisearth\.com\/v2\/user\/(?:mine|guest\/info)\/query\? url script-response-body https://raw.githubusercontent.com/0xlane/qx_scripts/master/kantian.js
 */

const SCRIPT_NAME = '看天';
const USER_REGEX = /https?:\/\/kantianapi\.geovisearth\.com\/v2\/user\/(?:mine|guest\/info)\/query\?/;
  ...
  if (magicJS.isResponse){
    if (USER_REGEX.test(magicJS.request.url)){
      try{
        ...
        obj['msg']['isLifeVip'] = 1;
        obj['msg']['isVipTry'] = 0;
        obj['msg']['vipStart'] = "2024-10-01";
        obj['msg']['vipEnd'] = "2099-10-01";
